...
namespace RoutesStation.API.Calculate
{
    ...
    public class CalculateMultiAPIController : ControllerBase
    {
        private readonly IFindPointRep _find;
        private readonly ApplicationDb _db;
        private readonly ITowPointRep _towPointRep;

        public CalculateMultiAPIController(IFindPointRep find,ApplicationDb db, ITowPointRep towPointRep)
        {
            _find = find;
            _db = db;
